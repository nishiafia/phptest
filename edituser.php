...
<form method="post"  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
	...
	<input type="radio" name="gender" <?php if (isset($oGender) && $oGender == "Male") echo "checked";?> value="Male">Male
	<input type="radio" name="gender" <?php if (isset($oGender) && $oGender == "Female") echo "checked";?> value="Female">Female
